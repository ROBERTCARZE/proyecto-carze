...
function cambiarTab(tab){
    ...
    // La barra de filtros global (Buscar/Responsables/Zonas/Clientes/PDF/+Responsable)
    // no aplica a "Sistema de Pendientes" (tiene sus propios filtros internos), se oculta ahí.
    var esPendientes = tab==='pendientes';
    document.getElementById('filtrosBar').style.display = esPendientes ? 'none' : 'flex';
    document.getElementById('contentArea').classList.toggle('pend-mode', esPendientes);
