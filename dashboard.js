...
function renderChartProduccion(){
    ...
    chartProduccion=new Chart(canvas,{
        type:'bar',
        data:{labels:labels,datasets:[
            {label:'Cotizaciones',data:cotCant,backgroundColor:'rgba(30,64,175,.75)',borderRadius:4,borderSkipped:false},
            {label:'Certificados',data:certCant,backgroundColor:'rgba(22,163,74,.75)',borderRadius:4,borderSkipped:false}
        ]},
        options:{responsive:true,maintainAspectRatio:false,
            plugins:{legend:{position:'bottom',labels:{boxWidth:10,font:{size:9,family:'Verdana'}}},
